# برای صفحه منو که گفته بود داینامیک باشه فرض کردم منظورش اینه که با توجه به کتگوری ها و منوآیتم هایی که داریم تو دیتابیس صفحه منو رو نشون بدیم اگر درست باشه اینی که گفتم یه پیکچر باید به مدل اضافه بشه 
